    ...
    <div>
      ...
      <div className="admin-page-grid">
        <div className="admin-form-card">
          <h3>+ Add Furniture</h3>
          <UploadBox preview={preview} onFile={setPreview} onClear={() => setPreview(null)} icon="🪑" label="Upload furniture image" />
          ...
          <button className="admin-submit-purple" onClick={addFurniture}>Add Furniture</button>
        </div>
        <div>
